...
export class GeminiClient {
   ...
   */
  private extractSearchReplaceBlocks(response: string): Array<{ search: string; replace: string }> {
...
The SEARCH block must match the original code EXACTLY (including whitespace and indentation).`;
   ...
   */
  private extractErrorContext(fileContent: string | undefined, errorLine: number, contextLines: number = 30): string {
